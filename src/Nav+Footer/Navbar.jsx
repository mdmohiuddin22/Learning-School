...
//     // Assuming login was successful, set showLoginAlert to true
...
//     logOut()
//       .then(() => {
//         // Assuming logout was successful, set showLogoutAlert to true
...
//   // Show login success alert when showLoginAlert is true
//   useEffect(() => {
//     if (showLoginAlert) {
//       Swal.fire({
//         icon: "success",
...
//       });
//       setShowLoginAlert(false); // Reset the flag after showing the alert
//     }
//   }, [showLoginAlert]);

//   // Show logout success alert when showLogoutAlert is true
//   useEffect(() => {
//     if (showLogoutAlert) {
//       Swal.fire({
//         icon: "success",
...
//         showConfirmButton: false,
//       });
//       setShowLogoutAlert(false); // Reset the flag after showing the alert
//     }
//   }, [showLogoutAlert]);
